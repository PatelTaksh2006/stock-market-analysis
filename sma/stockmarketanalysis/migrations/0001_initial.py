# Generated by Django 5.1.4 on 2025-03-10 10:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254)),
                ('mobile_no', models.BigIntegerField(blank=True, max_length=10, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, unique=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('no_of_purchase', models.IntegerField(blank=True, null=True)),
                ('price_of_buy', models.FloatField(blank=True, null=True)),
